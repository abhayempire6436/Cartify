  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
        ...
        <div className='w-full'>
            ...
            <textarea onChange={(e) => setDescription(e.target.value)} value={description} type="text" className='w-full max-w-[500px] px-3 py-2' placeholder='Write product description'></textarea>
        </div>
        ...
        <button className='w-20 py-2 mt-4 hover:bg-blue-700 bg-blue-600 text-white' type='submit'>ADD</button>
    </form>
  )
}
